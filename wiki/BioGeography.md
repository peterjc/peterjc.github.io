...
-   **GbifSearchResults** -- Contains the methods for conducting a GBIF
    ...
    -   Method print\_records for printing all contained records to
        screen.
-   **GbifDarwincoreXmlString** -- Contains the raw text returned by
    GBIF. If output to a file, this would be a standard XML file

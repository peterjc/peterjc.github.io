...
that looks like this `http://github.com/<your username>/biopython`
...
(either your own or ofiicial branch), you need to run
`git pull origin master` in a terminal window.
